	...
	; Compiler options:
	;
	; -q --opt=none --chip=18f4550 --outdir=comp/ --opt=+2 --ASMLIST \
	; --addrqual=request --std=c90 --output=+elf:multilocs \
	; -L--data-init -mno-keep-startup --runtime=+config --runtime=+c90lib \
	; --double=24 --float=24 --emi=wordwrite --output=+inhx032 \
	; --summary=-psect,-class,+mem,-hex,-file --rom=6840-7FFF main.c \
	; system/system.c system/memory.c system/usb_device.c \
	; system/usb_descriptors.c system/usb_device_hid.c system/usb_events.c \
