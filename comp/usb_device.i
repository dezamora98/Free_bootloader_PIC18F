...
# 6 "D:\DOCUMENTOS\PROGRAMAS_ESCUELA\xc8\v2.32\pic\include\c90\stddef.h"
...
# 174
volatile BDT_ENTRY BDT[((1 + 1) * 4)] __at(0x400);

# 179
volatile CTRL_TRF_SETUP SetupPkt __at((0x400+(((1 + 1) * 4)*4)));
volatile uint8_t CtrlTrfData[8] __at(((0x400+(((1 + 1) * 4)*4)) + 8));
