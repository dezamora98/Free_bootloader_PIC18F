...
# 18 "D:\DOCUMENTOS\PROGRAMAS_ESCUELA\xc8\v2.32\pic\include\xc.h"
extern const char __xc8_OPTIM_SPEED;

extern double __fpnormalize(double);


# 13 "D:\DOCUMENTOS\PROGRAMAS_ESCUELA\xc8\v2.32\pic\include\c90\xc8debug.h"
#pragma intrinsic(__builtin_software_breakpoint)
extern void __builtin_software_breakpoint(void);

# 13 "D:\DOCUMENTOS\PROGRAMAS_ESCUELA\xc8\v2.32\pic\include\c90\stdint.h"
...
# 7 "D:\DOCUMENTOS\PROGRAMAS_ESCUELA\xc8\v2.32\pic\include\builtins.h"
...
# 53 "D:\DOCUMENTOS\PROGRAMAS_ESCUELA\xc8\v2.32\pic\include\proc\pic18f4550.h"
...
# 19 "D:\DOCUMENTOS\PROGRAMAS_ESCUELA\xc8\v2.32\pic\include\pic18.h"
...
# 15 "D:\DOCUMENTOS\PROGRAMAS_ESCUELA\xc8\v2.32\pic\include\c90\stdbool.h"
...
# 4 "D:\DOCUMENTOS\PROGRAMAS_ESCUELA\xc8\v2.32\pic\include\__size_t.h"
typedef unsigned size_t;

# 14 "D:\DOCUMENTOS\PROGRAMAS_ESCUELA\xc8\v2.32\pic\include\c90\string.h"
...
# 51
extern uint8_t ReceivedDataBuffer[64] __at(0x500);
extern uint8_t ToSendDataBuffer[64] __at(0x540);
...
extern uint8_t SYS_state __at(0x000);
extern uint8_t PT0_BOOT __at(0x001);

# 75
inline void HID_tx(void);
inline void HID_rx(void);
void HID_transf(void) __at(0x69FF);
...
USBDeviceTasks();
if(USBDeviceState < CONFIGURED_STATE || UCONbits.SUSPND) continue;
USBOutHandle = (volatile void*)USBTransferOnePacket(1,0,&ReceivedDataBuffer[0],64);
if(ReceivedDataBuffer[0x01] == 0x02 && ReceivedDataBuffer[0x02] == 0x01)
{
boot();
}
...
inline void boot(void)
{
response_event(0x02, 0x01);

LATBbits.LATB5 = 1;

while(SYS_state == 0x02)
{
HID_rx();

switch (ReceivedDataBuffer[0x01])
{
case 0x03:
Write_event();
break;
...
{
uint8_t i;
response_event(0x03, 0x01);

SYS_state = 0x03;
PORTB |= 0b11100000;

while(SYS_state == 0x03)
{
HID_rx();
switch (ReceivedDataBuffer[0x02])
{
case 0x03:
i = flash_write_B32();
response_event(0x03, i);
PORTB = ~(PORTB & 0b11100000) & (PORTB | 0b11100000);
break;

case 0x02:
SYS_state = 0x02;
response_event(0x03, 0x02);
break;

default:
if(ReceivedDataBuffer[0x01] == 0x08)
{
...
{
uint8_t i;
response_event(0x04, 0x01);

SYS_state = 0x04;
LATBbits.LATB6 = 1;

while(SYS_state == 0x04)
{
HID_rx();
switch (ReceivedDataBuffer[0x02])
{
case 0x03:
flash_read_byte();
response_event(0x04, 0x03);
PORTB = ~(PORTB & 0b11100000) & (PORTB | 0b11100000);
break;

case 0x02:
SYS_state = 0x02;
response_event(0x04, 0x02);
break;
